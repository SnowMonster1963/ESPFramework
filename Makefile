...
HDR_FILES := include/driver/Stream.h \
...
build/user/user_main.o: $(HDR_FILES)
build/driver/Timer.o: include/driver/Timer.h
build/driver/Stream.o: include/driver/Stream.h include/driver/InterruptBlocker.h
build/driver/Process.o: include/driver/Process.h include/driver/InterruptBlocker.h
build/driver/Socket.o: include/driver/Socket.h include/driver/Process.h include/driver/InterruptBlocker.h
build/driver/WiFi.o: include/driver/WiFi.h include/driver/Process.h include/driver/InterruptBlocker.h
build/driver/WiFiTasks.o: include/driver/WiFi.h include/driver/Process.h include/driver/InterruptBlocker.h
...
flashuserinit:
	$(vecho) "Flash init User data:"
	$(vecho) "blank.bin-------->0x3c000"
	$(vecho) "blank.bin-------->0x3d000"
	$(ESPTOOL) -p $(ESPPORT) write_flash $(flashimageoptions) \
		0x3c000 $(SDK_BASE)/bin/blank.bin \
		0x3d000 $(SDK_BASE)/bin/blank.bin
